...
public class Hub {
     ...
     */
    synchronized public ArrayList<Integer> getPlayerList() {
    	ArrayList<Integer> players = new ArrayList<>();
    	for(Integer id: playerConnections.keySet()) {
    		players.add(id);
    	}
    	return players;
...
//        return players;
    ...
    synchronized private void acceptConnection(ConnectionToClient newConnection) {
        Integer ID = newConnection.getPlayer();
    ...
    private class ConnectionToClient { // Handles communication with one client.
        ...
        private Integer playerID;  // The ID number for this player.
