...
public class ForwardedMessage implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1859827184677052650L;
	public final Object message;  // Original message from a client.
    public final Integer senderID;    // The ID of the client who sent that message.
     ...
     */
    public ForwardedMessage(Integer senderID, Object message) {
