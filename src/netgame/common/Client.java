...
abstract public class Client {
     ...
     */
    protected ArrayList<Integer> connectedPlayerIDs = new ArrayList<>();
    ...
    public ArrayList<Integer> getConnectedPlayers() {
    ...
    private  class ConnectionToHub {
        ...
        private final Integer id_number;               // The ID of this client, assigned by the hub.
        ...
        private class SendThread extends Thread {
            public void run() {
                ...
                try {
                 ...
                 //       new Alert(AlertType.ERROR, "The server disconnected").show();
                    }
                }
                catch (Exception e) {
                    if ( ! closed ) {
